...
import { homeOutline, personOutline, notificationsOutline,bookOutline, logOutOutline } from "ionicons/icons"
                ...
                <ul>
                    <li>
                        <Link to="/dashboard">
                            ...
                            <span class="title_title">Hariny Library</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/dashboard">
