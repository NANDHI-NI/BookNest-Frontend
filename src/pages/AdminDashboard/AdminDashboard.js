...
// import HomeImage from "../../styles/images/home.jpg"
...
function AdminDashboard() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/api/admin/' + adminId)
            .then(response => {
    ...
    const handleUpdate = () => {
        ...
        axios.put('http://localhost:8080/api/books/' + editID, { id: editID, bookTitle: uBookTitle, author: author, category: category, quantity: uQuantity, availability: uAvailability, description: uDescription, publishedDate: publishedDate })
            .then(res => {
                console.log(res);
    ...
    const handleDelete = (id) => {
        console.log("Deleting book with ID:", id); // Add this line
        axios.delete('http://localhost:8080/api/books/' + id)
            .then(res => {
                console.log("Book deleted:", res); // Add this line
                window.location.reload(false);
            }).catch(err => {
                console.log("Error deleting book:", err); // Add this line
                console.log(err);
            });
    }
